...
# Prepend the parent directory of backend/database/migrations/ to sys.path so we can import from app
...
# 3. Import ALL models before setting metadata.
...
# Optional check: print registered tables to ensure Alembic sees users
print("Registered metadata tables:", list(target_metadata.tables.keys()))
