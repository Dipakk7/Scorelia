      ...
      {repositories.map((repo) => (
        ...
        >
          <CardContent className="p-5 flex flex-col justify-between h-full gap-4 text-left">
            <div className="space-y-2 text-left">
              <div className="flex items-start justify-between text-left">
                <div className="flex items-center gap-2 text-slate-805 dark:text-slate-100 font-bold tracking-tight text-xs truncate leading-none text-left">
                  ...
                  <span className="truncate group-hover:text-brand-500 dark:group-hover:text-brand-400 transition-colors leading-none">
                    {repo.name}
                  </span>
                </div>
                <a
            ...
            <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-850/60 pt-3 text-[10px] font-bold text-slate-455 select-none leading-none">
              ...
              <Badge className="bg-brand-500/10 hover:bg-brand-500/20 text-brand-655 dark:text-brand-400 border border-brand-500/10 font-bold text-[9px] uppercase tracking-widest leading-none rounded-lg select-none px-2 py-1 shrink-0">
                Repository
              </Badge>
            </div>
          </CardContent>
