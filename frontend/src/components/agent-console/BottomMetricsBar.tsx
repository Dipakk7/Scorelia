...
export function BottomMetricsBar({ className }: BottomMetricsBarProps) {
  return (
    <div
      className={cn(
        'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4 items-stretch p-4 sm:p-5 rounded-2xl bg-[#0e101d] border border-white/10 text-left shadow-xl',
        className
      )}
    >
      {/* 1. Storage Used */}
      <div className="flex items-center gap-3 p-3 rounded-xl bg-[#141628] border border-white/5 h-full">
        ...
        <div className="flex-1 min-w-0 space-y-1">
          <div className="flex justify-between text-[11px] font-semibold">
            ...
            <span className="text-white font-bold">1.2 GB <span className="text-slate-400 font-normal">/ 10 GB</span></span>
          </div>
      ...
      <div className="flex items-center gap-3 p-3 rounded-xl bg-[#141628] border border-white/5 h-full">
        ...
        <div className="flex-1 min-w-0 space-y-1">
          <div className="flex justify-between text-[11px] font-semibold">
            ...
            <span className="text-white font-bold">342 <span className="text-slate-400 font-normal">/ 1,000</span></span>
          </div>
          <div className="h-1.5 w-full bg-slate-800 rounded-full overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-3 rounded-xl bg-[#141628] border border-white/5 h-full">
        ...
        <div className="flex-1 min-w-0">
          <span className="text-[11px] font-semibold text-slate-300 block">Automations Running</span>
      ...
      <div className="flex items-center gap-3 p-3 rounded-xl bg-[#141628] border border-white/5 h-full">
        ...
        <div className="flex-1 min-w-0">
          <span className="text-[11px] font-semibold text-slate-300 block">Knowledge Base Size</span>
          <div className="flex items-baseline gap-1.5">
      ...
      <div className="flex items-center gap-3 p-3 rounded-xl bg-[#141628] border border-white/5 h-full">
        ...
        <div className="flex-1 min-w-0">
          <span className="text-[11px] font-semibold text-slate-300 block">System Status</span>
      ...
      <div className="flex items-center justify-between p-3 rounded-xl bg-[#141628] border border-white/5 h-full">
