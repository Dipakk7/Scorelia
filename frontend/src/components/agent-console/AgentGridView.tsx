...
export function AgentGridView({
  ...
  return (
    <div
      className={cn(
        'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3.5 items-stretch text-left',
        className
      )}
    >
      {agents.map((agent) => (
        <div
          ...
          className="p-4 rounded-xl bg-[#0b0c14] border border-white/5 hover:border-purple-500/30 shadow-lg space-y-3 transition-all hover:-translate-y-0.5 cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 flex flex-col justify-between"
        >
          {/* Header row */}
