...
export const ReferencesSection: React.FC<ReferencesSectionProps> = ({
  ...
  return (
    <div className="space-y-5 animate-fade-in text-left">
      ...
      <div className="bg-slate-50/80 dark:bg-[#171a2b] border border-slate-200/70 dark:border-white/[0.08] rounded-xl p-4 flex items-center justify-between gap-3 shadow-sm dark:shadow-[0_4px_16px_-2px_rgba(0,0,0,0.35)] transition-colors">
        <div>
