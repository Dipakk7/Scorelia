...
export const ReferencesSection: React.FC<ReferencesSectionProps> = ({
  ...
  return (
    <div className="space-y-5 animate-fade-in text-left">
      ...
      <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-white/10 rounded-xl p-4 flex items-center justify-between gap-3 shadow-sm transition-colors">
        <div>
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div className="w-9 h-5 bg-slate-300 dark:bg-slate-800 peer-focus:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-purple-500/80 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-purple-600"></div>
        </label>
      </div>
