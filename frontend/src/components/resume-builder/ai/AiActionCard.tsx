...
export const AiActionCard: React.FC<AiActionCardProps> = ({ action, onExecute }) => {
  ...
  return (
    <div className="p-3.5 rounded-xl bg-slate-50/80 dark:bg-[#131524]/90 border border-slate-200/70 dark:border-slate-800/80 hover:border-purple-500/40 shadow-sm dark:shadow-[0_4px_16px_-4px_rgba(0,0,0,0.4)] transition-all space-y-2.5 text-left group">
      <div className="flex items-start justify-between gap-2">
        ...
        <span className="px-2 py-0.5 rounded-full text-[10px] font-mono font-extrabold bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-500/30 shrink-0">
