...
export const AiEmptyState: React.FC = () => {
  return (
    <div className="p-6 text-center space-y-3 bg-[#121424]/95 border border-dashed border-slate-800/90 rounded-2xl">
      ...
      <div className="space-y-1">
        ...
        <p className="text-[11px] text-slate-300 font-medium m-0">
    ...
    <div className="p-3 bg-pink-950/30 border border-pink-500/30 rounded-xl flex items-center justify-between text-xs text-pink-200 gap-2">
      ...
      {onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="text-[10px] font-bold text-pink-300 hover:underline cursor-pointer shrink-0 focus:outline-none"
        >
          Retry
        </button>
      )}
