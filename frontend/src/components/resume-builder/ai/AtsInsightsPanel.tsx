...
export const AtsInsightsPanel: React.FC = () => {
  return (
    <div className="space-y-4 text-left font-sans">
      ...
      <div className="bg-slate-50/80 dark:bg-[#171a2b] border border-slate-200/70 dark:border-white/[0.08] rounded-xl p-4 space-y-3 shadow-sm dark:shadow-[0_4px_16px_-2px_rgba(0,0,0,0.35)] transition-colors">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-1 space-y-1.5 text-xs">
            ...
            <div className="w-full bg-slate-200 dark:bg-[#1f2238] h-1.5 rounded-full overflow-hidden">
      ...
      <div className="bg-slate-50/80 dark:bg-[#171a2b] border border-slate-200/70 dark:border-white/[0.08] rounded-xl p-4 space-y-2.5 shadow-sm dark:shadow-[0_4px_16px_-2px_rgba(0,0,0,0.35)] transition-colors">
      ...
      <div className="bg-slate-50/80 dark:bg-[#171a2b] border border-slate-200/70 dark:border-white/[0.08] rounded-xl p-4 space-y-2.5 shadow-sm dark:shadow-[0_4px_16px_-2px_rgba(0,0,0,0.35)] transition-colors">
        ...
        <div className="space-y-2 text-xs">
          {[
            ...
            <div key={idx} className="flex items-center justify-between p-2 rounded-lg bg-white dark:bg-[#181a2b] border border-slate-200/80 dark:border-slate-800">
