...
export function AnswerPanel({
  ...
  if (isLoading) {
    return (
      <Card className="border border-border bg-card/70 backdrop-blur-md rounded-2xl shadow-sm hover:border-slate-350 dark:hover:border-slate-750 transition-all duration-300 overflow-hidden text-left font-sans text-xs animate-pulse">
    ...
    return (
      <Card className="border border-border bg-card/70 backdrop-blur-md rounded-2xl shadow-sm hover:border-slate-350 dark:hover:border-slate-750 transition-all duration-300 overflow-hidden text-left font-sans text-xs">
        <CardContent className="py-16 text-center text-muted-foreground flex flex-col items-center justify-center gap-3">
          ...
          <h3 className="text-muted-foreground font-black font-display text-sm m-0 leading-none">No Answer Generated</h3>
          <p className="max-w-xs text-[10px] text-muted-foreground leading-relaxed m-0 font-medium">
      ...
      <div>
        <CardHeader className="pb-4 border-b border-border/60 text-left flex flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Badge variant="outline" className="text-[9px] font-black uppercase tracking-wider py-0.5 px-2 border-border text-slate-500 rounded-lg leading-none shrink-0 bg-transparent">
        ...
        <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-200/50 dark:border-slate-850/60">
          <div className="flex items-center gap-2">
            <Button
              ...
              size="sm"
              onClick={handleCopy}
              className="text-xs py-1.5 px-3 flex items-center gap-1.5 border border-border bg-white hover:border-brand-500/30 hover:bg-brand-500/5 transition-all rounded-xl h-8 font-bold cursor-pointer dark:bg-transparent bg-transparent"
            >
              <Copy size={13} />
              <span>Copy</span>
            </Button>
