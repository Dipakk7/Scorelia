...
import type { PlatformActivityPoint } from '@/data/analyticsChartsMockData'
...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="p-3 rounded-xl bg-[#121320] border border-white/10 shadow-2xl backdrop-blur-md text-xs space-y-1.5 min-w-[140px] text-left">
...
export function PlatformActivityChart({
  data = analyticsChartsMockData.platformActivity,
  isLoading = false,
  isEmpty = false,
  className = '',
      ...
      <div className="w-full h-56 my-1">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            <defs>
              <linearGradient id="purpleSessionsGrad" x1="0" y1="0" x2="0" y2="1">
