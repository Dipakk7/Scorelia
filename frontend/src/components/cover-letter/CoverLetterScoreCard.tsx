    ...
    <div className="rounded-2xl bg-[#121426] border border-white/10 bg-gradient-to-r from-[#14162a] via-[#111324] to-[#14162a] p-4 sm:p-5 md:p-6 shadow-lg shadow-purple-950/10 space-y-4 sm:space-y-5 text-left transition-all">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-800/80">
        <div>
          ...
          <p className="text-xs text-slate-400 font-medium m-0 mt-1">
            Comprehensive quality score breakdown, pre-export verification checklist, and multi-format export triggers.
          </p>
        </div>
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 shadow-md border border-purple-500/30 transition-all cursor-pointer shrink-0 self-start sm:self-auto"
        >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-xl border border-slate-800 bg-slate-900/80">
        <div className="flex items-center gap-4">
          <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-tr from-purple-600 to-indigo-500 text-white font-black text-xl shadow-lg shrink-0">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-bold shrink-0">
