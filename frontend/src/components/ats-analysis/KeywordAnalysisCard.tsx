  ...
  return (
    <div className="rounded-2xl bg-slate-900/90 border border-slate-800/90 p-5 shadow-lg space-y-5">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2 min-h-[160px] max-h-80 overflow-y-auto p-3 bg-slate-950/90 border border-slate-800/80 rounded-xl shadow-inner scrollbar-none w-full">
