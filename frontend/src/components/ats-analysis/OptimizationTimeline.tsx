  ...
  return (
    <div className="rounded-2xl bg-slate-900/90 border border-slate-800/90 p-4 sm:p-5 shadow-lg space-y-3.5 h-full flex flex-col justify-between">
      ...
      <div className="w-full">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 w-full p-1">
          {mockOptimizationTimeline.map((step) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'flex items-center gap-2 px-3 py-2 rounded-xl border text-xs font-medium transition-all cursor-pointer w-full justify-start',
                  isSelected
              ...
              >
                <div
                  className={cn(
                    'w-5 h-5 rounded-full flex items-center justify-center text-[11px] font-mono font-bold shrink-0',
                    isCompleted
