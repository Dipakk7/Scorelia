...
export function CareerRoadmapEmpty({
  ...
  return (
    <Card className={cn('p-8 sm:p-12 bg-[#121320] border border-white/10 rounded-3xl text-center space-y-4 shadow-sm text-left', className)}>
      ...
      {onAction && (
        <div className="pt-2 flex justify-center">
          <Button
            ...
            size="sm"
            onClick={onAction}
            className="flex items-center gap-2 text-xs font-bold py-2.5 px-5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white cursor-pointer border-none"
          >
