    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
        <div className="p-3 rounded-xl border border-slate-700/80 bg-slate-900/80">
          ...
          <div className="text-lg font-extrabold text-white mt-1 font-mono">{metrics.opened}</div>
        </div>

        <div className="p-3 rounded-xl border border-slate-700/80 bg-slate-900/80">
          <div className="text-[10px] text-slate-400 font-sans">Closed Issues</div>
          <div className="text-lg font-extrabold text-emerald-400 mt-1 font-mono">{metrics.closed}</div>
        </div>

        <div className="p-3 rounded-xl border border-slate-700/80 bg-slate-900/80">
          <div className="text-[10px] text-slate-400 font-sans">Avg Resolution Time</div>
          <div className="text-lg font-extrabold text-sky-400 mt-1 font-mono">{metrics.averageResolutionTime}</div>
        </div>

        <div className="p-3 rounded-xl border border-slate-700/80 bg-slate-900/80">
          <div className="text-[10px] text-slate-400 font-sans">Reopened</div>
          <div className="text-lg font-extrabold text-amber-400 mt-1 font-mono">{metrics.reopened}</div>
        </div>
      </div>
      ...
      <div className="space-y-1.5 p-3 rounded-xl border border-slate-700/80 bg-slate-900/60 font-sans">
        <div className="flex items-center justify-between text-xs font-semibold">
          ...
          <span className="text-emerald-400 font-bold font-mono">{metrics.resolutionRate}%</span>
        </div>
